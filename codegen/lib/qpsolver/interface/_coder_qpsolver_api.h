...
extern void qpsolver(boolean_T init, struct0_T thruster_data[8], struct1_T T_r,
                     real_T N_enabled_thruster, real_T rudder_table0[45], real_T
                     no_azi_angle_constr, real_T method, emxArray_real_T
                     *solution, struct2_T alloc_out[8], real_T *status);
extern void qpsolver_api(const mxArray *prhs[7], const mxArray *plhs[4]);
