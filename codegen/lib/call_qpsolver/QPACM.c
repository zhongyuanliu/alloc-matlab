  ...
  emxArray_real_T *u)
{
  ...
  emxArray_real_T *d_y;
  i11 = g->size[0];
  emxEnsureCapacity((emxArray__common *)g, i11, (int)sizeof(double));
  kAcol = g->size[0];
  for (i11 = 0; i11 < kAcol; i11++) {
    g->data[i11] = -g->data[i11];
  }
  ...
  b_A->size[0] = A->size[1];
  b_A->size[1] = A->size[0];
  emxEnsureCapacity((emxArray__common *)b_A, i11, (int)sizeof(double));
  kAcol = A->size[0];
  for (i11 = 0; i11 < kAcol; i11++) {
    mn = A->size[1];
    for (i12 = 0; i12 < mn; i12++) {
      b_A->data[i12 + b_A->size[0] * i11] = A->data[i11 + A->size[0] * i12];
    }
  }
  ...
  for (i11 = 0; i11 < kAcol; i11++) {
    mn = b_A->size[0];
    for (i12 = 0; i12 < mn; i12++) {
      A->data[i12 + A->size[0] * i11] = b_A->data[i12 + b_A->size[0] * i11];
    }
  }
  ...
  if (A->size[1] != 0) {
    ...
    kAcol = Q->size[0];
    mn = A->size[1];
    i11 = Q1->size[0] * Q1->size[1];
    Q1->size[0] = kAcol;
    Q1->size[1] = mn;
    emxEnsureCapacity((emxArray__common *)Q1, i11, (int)sizeof(double));
    for (i11 = 0; i11 < mn; i11++) {
      for (i12 = 0; i12 < kAcol; i12++) {
        Q1->data[i12 + Q1->size[0] * i11] = Q->data[i12 + Q->size[0] * i11];
      }
    }
    ...
    kAcol = Q->size[0];
    i13 = Q2->size[0] * Q2->size[1];
    Q2->size[0] = kAcol;
    Q2->size[1] = i12 - i11;
    emxEnsureCapacity((emxArray__common *)Q2, i13, (int)sizeof(double));
    mn = i12 - i11;
    for (i13 = 0; i13 < mn; i13++) {
      for (i14 = 0; i14 < kAcol; i14++) {
        Q2->data[i14 + Q2->size[0] * i13] = Q->data[i14 + Q->size[0] * ((i11 +
          i13) - 1)];
      }
    }
    ...
    for (i13 = 0; i13 < mn; i13++) {
      for (i14 = 0; i14 < kAcol; i14++) {
        R->data[i14 + R->size[0] * i13] = Q2t->data[i14 + Q2t->size[0] * i13];
      }
    }

    emxInit_real_T1(&b_G, 2);
    i13 = b_G->size[0] * b_G->size[1];
    b_G->size[0] = R->size[1];
    b_G->size[1] = R->size[0];
    emxEnsureCapacity((emxArray__common *)b_G, i13, (int)sizeof(double));
    kAcol = R->size[0];
    for (i13 = 0; i13 < kAcol; i13++) {
      mn = R->size[1];
      for (i14 = 0; i14 < mn; i14++) {
        b_G->data[i14 + b_G->size[0] * i13] = R->data[i13 + R->size[0] * i14];
      }
    }
    ...
    if ((b_G->size[0] == 0) || ((b->size[0] == 0) || (b->size[1] == 0))) {
      ...
      i13 = py->size[0] * py->size[1];
      py->size[0] = (int)unnamed_idx_0;
      py->size[1] = (int)unnamed_idx_1;
      emxEnsureCapacity((emxArray__common *)py, i13, (int)sizeof(double));
      ...
      n = b_G->size[1];
      i13 = Q2t->size[0] * Q2t->size[1];
      Q2t->size[0] = b_G->size[0];
      Q2t->size[1] = b_G->size[1];
      emxEnsureCapacity((emxArray__common *)Q2t, i13, (int)sizeof(double));
      kAcol = b_G->size[0] * b_G->size[1];
      for (i13 = 0; i13 < kAcol; i13++) {
        Q2t->data[i13] = b_G->data[i13];
      }
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        r6->data[i13] = py->data[i13];
      }

      xtrsm(b_G->size[1], b->size[1], Q2t, b_G->size[1], r6, b_G->size[1]);
      i13 = py->size[0] * py->size[1];
      py->size[0] = r6->size[0];
      py->size[1] = r6->size[1];
      emxEnsureCapacity((emxArray__common *)py, i13, (int)sizeof(double));
      kAcol = r6->size[0] * r6->size[1];
      for (i13 = 0; i13 < kAcol; i13++) {
        py->data[i13] = r6->data[i13];
      }
    } else {
    ...
    for (i13 = 0; i13 < kAcol; i13++) {
      mn = Q2->size[1];
      for (i14 = 0; i14 < mn; i14++) {
        Q2t->data[i14 + Q2t->size[0] * i13] = Q2->data[i13 + Q2->size[0] * i14];
      }
    }

    i13 = A->size[1];
    emxInit_real_T1(&y, 2);
    if ((i13 == 1) || (py->size[0] == 1)) {
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        ...
        for (i14 = 0; i14 < mn; i14++) {
          ...
          for (iy = 0; iy < jBcol; iy++) {
            y->data[i13 + y->size[0] * i14] += Q1->data[i13 + Q1->size[0] * iy] *
              py->data[iy + py->size[0] * i14];
          }
        }
      }
    } else {
    ...
    if ((G->size[1] == 1) || (y->size[0] == 1)) {
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        ...
        for (i14 = 0; i14 < mn; i14++) {
          ...
          jBcol = G->size[1];
          for (iy = 0; iy < jBcol; iy++) {
            b_y->data[i13 + b_y->size[0] * i14] += G->data[i13 + G->size[0] * iy]
              * y->data[iy + y->size[0] * i14];
          }
        }
      }
    } else {
      ...
      if ((G->size[0] == 0) || (y->size[1] == 0)) {
        ...
        while ((m > 0) && (kAcol <= jBcol)) {
          ar = 0;
          i13 = nb + k;
          for (b_n = nb; b_n + 1 <= i13; b_n++) {
            if (y->data[b_n] != 0.0) {
              ia = ar;
              i14 = kAcol + m;
              for (ix = kAcol; ix + 1 <= i14; ix++) {
                ia++;
                b_y->data[ix] += y->data[b_n] * G->data[ia - 1];
              }
            }
    ...
    emxFree_real_T(&y);
    i13 = pz->size[0];
    pz->size[0] = b_y->size[0];
    emxEnsureCapacity((emxArray__common *)pz, i13, (int)sizeof(double));
    kAcol = b_y->size[0];
    for (i13 = 0; i13 < kAcol; i13++) {
      pz->data[i13] = b_y->data[i13] + g->data[i13];
    }
    ...
    if ((Q2t->size[1] == 1) || (pz->size[0] == 1)) {
      ...
      emxEnsureCapacity((emxArray__common *)gz, i13, (int)sizeof(double));
      kAcol = Q2t->size[0];
      for (i13 = 0; i13 < kAcol; i13++) {
        gz->data[i13] = 0.0;
        mn = Q2t->size[1];
        for (i14 = 0; i14 < mn; i14++) {
          gz->data[i13] += Q2t->data[i13 + Q2t->size[0] * i14] * pz->data[i14];
        }
      }
    } else {
      k = Q2t->size[1];
    ...
    if ((Q2t->size[1] == 1) || (G->size[0] == 1)) {
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        ...
        for (i14 = 0; i14 < mn; i14++) {
          ...
          jBcol = Q2t->size[1];
          for (iy = 0; iy < jBcol; iy++) {
            c_y->data[i13 + c_y->size[0] * i14] += Q2t->data[i13 + Q2t->size[0] *
              iy] * G->data[iy + G->size[0] * i14];
          }
        }
      }
    } else {
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        mn = c_y->size[0];
        for (i14 = 0; i14 < mn; i14++) {
          c_y->data[i14 + c_y->size[0] * i13] = 0.0;
        }
      }
        ...
        while ((m > 0) && (kAcol <= jBcol)) {
          ...
          for (b_n = nb; b_n + 1 <= i13; b_n++) {
            if (G->data[b_n] != 0.0) {
              ...
              for (ix = kAcol; ix + 1 <= i14; ix++) {
                ia++;
                c_y->data[ix] += G->data[b_n] * Q2t->data[ia - 1];
              }
            }
    ...
    if (c_y->size[1] == 1) {
      ...
      if (i13 == 1) {
        ...
        for (i13 = 0; i13 < kAcol; i13++) {
          mn = Gz->size[0];
          for (i14 = 0; i14 < mn; i14++) {
            Gz->data[i14 + Gz->size[0] * i13] = 0.0;
          }
        }

        if ((c_y->size[0] == 0) || (i12 - i11 == 0)) {
        } else {
          jBcol = c_y->size[0] * ((i12 - i11) - 1);
          kAcol = 0;
          while ((m > 0) && (kAcol <= jBcol)) {
            i13 = kAcol + m;
            for (ix = kAcol; ix + 1 <= i13; ix++) {
          ...
          while ((m > 0) && (kAcol <= jBcol)) {
            ...
            for (b_n = nb; b_n + 1 <= i13; b_n++) {
              i14 = Q->size[0];
              if (Q->data[b_n % i14 + Q->size[0] * ((i11 + b_n / i14) - 1)] !=
                  0.0) {
                ia = ar;
                i14 = kAcol + m;
                for (ix = kAcol; ix + 1 <= i14; ix++) {
                  ia++;
                  iy = Q->size[0];
                  Gz->data[ix] += Q->data[b_n % iy + Q->size[0] * ((i11 + b_n /
                    iy) - 1)] * c_y->data[ia - 1];
                }
              }
    ...
    if (guard1) {
      ...
      for (i13 = 0; i13 < kAcol; i13++) {
        mn = Q2->size[1];
        for (i14 = 0; i14 < mn; i14++) {
          Gz->data[i13 + Gz->size[0] * i14] = 0.0;
          jBcol = c_y->size[1];
          for (iy = 0; iy < jBcol; iy++) {
            Gz->data[i13 + Gz->size[0] * i14] += c_y->data[i13 + c_y->size[0] *
              iy] * Q2->data[iy + Q2->size[0] * i14];
          }
        }
      }
    }
          ...
          if (wj > 0.0) {
            ...
            if (j + 1 < b_n) {
              ...
              if ((j == 0) || (nb + 1 == 0)) {
                ...
                iy = mn;
                i13 = jBcol + n * nb;
                for (kAcol = jBcol; kAcol <= i13; kAcol += n) {
                  ix = m + 1;
                  c = 0.0;
                  i14 = (kAcol + j) - 1;
                  for (ia = kAcol; ia <= i14; ia++) {
    ...
    for (i13 = 0; i13 < kAcol; i13++) {
      mn = b_G->size[1];
      for (i14 = 0; i14 < mn; i14++) {
        Q2t->data[i14 + Q2t->size[0] * i13] = b_G->data[i13 + b_G->size[0] * i14];
      }
    }
    ...
    emxEnsureCapacity((emxArray__common *)b_gz, i13, (int)sizeof(double));
    kAcol = gz->size[0];
    for (i13 = 0; i13 < kAcol; i13++) {
      b_gz->data[i13] = -gz->data[i13];
    }

    emxFree_real_T(&gz);
    emxInit_real_T1(&b_Q2t, 2);
    b_mldivide(Q2t, b_gz, pz);
    i13 = b_Q2t->size[0] * b_Q2t->size[1];
    b_Q2t->size[0] = Q2t->size[1];
    b_Q2t->size[1] = Q2t->size[0];
    emxEnsureCapacity((emxArray__common *)b_Q2t, i13, (int)sizeof(double));
    kAcol = Q2t->size[0];
    emxFree_real_T(&b_gz);
    for (i13 = 0; i13 < kAcol; i13++) {
      mn = Q2t->size[1];
      for (i14 = 0; i14 < mn; i14++) {
        b_Q2t->data[i14 + b_Q2t->size[0] * i13] = Q2t->data[i13 + Q2t->size[0] *
          i14];
      }
    }
    ...
    emxEnsureCapacity((emxArray__common *)b_pz, i13, (int)sizeof(double));
    kAcol = pz->size[0];
    for (i13 = 0; i13 < kAcol; i13++) {
      b_pz->data[i13] = pz->data[i13];
    }

    b_mldivide(b_Q2t, b_pz, pz);
    emxFree_real_T(&b_pz);
    emxFree_real_T(&b_Q2t);
    if ((i12 - i11 == 1) || (pz->size[0] == 1)) {
      i11 = x->size[0];
      x->size[0] = Q2->size[0];
      emxEnsureCapacity((emxArray__common *)x, i11, (int)sizeof(double));
      kAcol = Q2->size[0];
      for (i11 = 0; i11 < kAcol; i11++) {
        x->data[i11] = 0.0;
        mn = Q2->size[1];
        for (i12 = 0; i12 < mn; i12++) {
          x->data[i11] += Q2->data[i11 + Q2->size[0] * i12] * pz->data[i12];
        }
      }
    } else {
      k = i12 - i11;
      ...
      if (i13 == 0) {
        ...
        while ((i12 > 0) && (kAcol <= 0)) {
          ...
          for (b_n = nb; b_n + 1 <= i13; b_n++) {
            if (pz->data[b_n] != 0.0) {
              ia = ar;
              for (ix = 0; ix + 1 <= i12; ix++) {
                ia++;
                i14 = Q->size[0];
                x->data[ix] += pz->data[b_n] * Q->data[(ia - 1) % i14 + Q->size
                  [0] * ((i11 + (ia - 1) / i14) - 1)];
              }
            }
    ...
    i11 = A->size[1];
    emxInit_real_T1(&C, 2);
    if ((i11 == 1) || (py->size[0] == 1)) {
      i11 = C->size[0] * C->size[1];
      C->size[0] = Q1->size[0];
      C->size[1] = py->size[1];
      emxEnsureCapacity((emxArray__common *)C, i11, (int)sizeof(double));
      kAcol = Q1->size[0];
      for (i11 = 0; i11 < kAcol; i11++) {
        mn = py->size[1];
        for (i12 = 0; i12 < mn; i12++) {
          ...
          jBcol = Q1->size[1];
          for (i13 = 0; i13 < jBcol; i13++) {
            C->data[i11 + C->size[0] * i12] += Q1->data[i11 + Q1->size[0] * i13]
              * py->data[i13 + py->size[0] * i12];
          }
        }
      }
    } else {
      ...
      i13 = Q->size[0];
      if ((i13 == 0) || (py->size[1] == 0)) {
      } else {
        i13 = Q->size[0];
        jBcol = i13 * (py->size[1] - 1);
        kAcol = 0;
        while ((i12 > 0) && (kAcol <= jBcol)) {
          i13 = kAcol + i12;
          for (ix = kAcol; ix + 1 <= i13; ix++) {
            C->data[ix] = 0.0;
          }
          ...
          for (b_n = nb; b_n + 1 <= i13; b_n++) {
            if (py->data[b_n] != 0.0) {
              ...
              for (ix = kAcol; ix + 1 <= i14; ix++) {
                ia++;
                iy = Q->size[0];
                C->data[ix] += py->data[b_n] * Q->data[(ia - 1) % iy + Q->size[0]
                  * ((ia - 1) / iy)];
              }
            }
    ...
    if ((G->size[1] == 1) || (x->size[0] == 1)) {
      i11 = b_C->size[0];
      b_C->size[0] = G->size[0];
      emxEnsureCapacity((emxArray__common *)b_C, i11, (int)sizeof(double));
      kAcol = G->size[0];
      for (i11 = 0; i11 < kAcol; i11++) {
        b_C->data[i11] = 0.0;
        mn = G->size[1];
        for (i12 = 0; i12 < mn; i12++) {
          b_C->data[i11] += G->data[i11 + G->size[0] * i12] * x->data[i12];
        }
      }
    } else {
      k = G->size[1];
      ...
      if (G->size[0] == 0) {
        ...
        while ((m > 0) && (kAcol <= 0)) {
          ar = 0;
          i11 = nb + k;
          for (b_n = nb; b_n + 1 <= i11; b_n++) {
            if (x->data[b_n] != 0.0) {
              ia = ar;
              for (ix = 0; ix + 1 <= m; ix++) {
                ia++;
                b_C->data[ix] += x->data[b_n] * G->data[ia - 1];
              }
            }
    ...
    i11 = Q2t->size[0] * Q2t->size[1];
    Q2t->size[0] = Q1->size[1];
    Q2t->size[1] = Q1->size[0];
    emxEnsureCapacity((emxArray__common *)Q2t, i11, (int)sizeof(double));
    kAcol = Q1->size[0];
    for (i11 = 0; i11 < kAcol; i11++) {
      mn = Q1->size[1];
      for (i12 = 0; i12 < mn; i12++) {
        Q2t->data[i12 + Q2t->size[0] * i11] = Q1->data[i11 + Q1->size[0] * i12];
      }
    }
    ...
    kAcol = b_C->size[0];
    for (i11 = 0; i11 < kAcol; i11++) {
      b_C->data[i11] += g->data[i11];
    }

    emxInit_real_T(&d_y, 1);
    if ((Q2t->size[1] == 1) || (b_C->size[0] == 1)) {
      i11 = d_y->size[0];
      d_y->size[0] = Q2t->size[0];
      emxEnsureCapacity((emxArray__common *)d_y, i11, (int)sizeof(double));
      kAcol = Q2t->size[0];
      for (i11 = 0; i11 < kAcol; i11++) {
        d_y->data[i11] = 0.0;
        mn = Q2t->size[1];
        for (i12 = 0; i12 < mn; i12++) {
          d_y->data[i11] += Q2t->data[i11 + Q2t->size[0] * i12] * b_C->data[i12];
        }
      }
    } else {
      k = Q2t->size[1];
      ...
      while (kAcol <= 0) {
        ...
        for (b_n = nb; b_n + 1 <= i11; b_n++) {
          if (b_C->data[b_n] != 0.0) {
            ...
            for (ix = 0; ix + 1 <= m; ix++) {
              ia++;
              d_y->data[ix] += b_C->data[b_n] * Q2t->data[ia - 1];
            }
          }
    ...
    emxFree_real_T(&Q2t);
    b_mldivide(R, d_y, pz);
    i11 = u->size[0] * u->size[1];
    u->size[0] = pz->size[0];
    u->size[1] = 1;
    emxEnsureCapacity((emxArray__common *)u, i11, (int)sizeof(double));
    kAcol = pz->size[0];
    emxFree_real_T(&d_y);
    emxFree_real_T(&R);
    for (i11 = 0; i11 < kAcol; i11++) {
      u->data[i11] = pz->data[i11];
    }

    emxFree_real_T(&pz);
  } else {
    emxInit_real_T1(&b_G, 2);
    i11 = b_G->size[0] * b_G->size[1];
    b_G->size[0] = G->size[0];
    b_G->size[1] = G->size[1];
    emxEnsureCapacity((emxArray__common *)b_G, i11, (int)sizeof(double));
    kAcol = G->size[0] * G->size[1];
    for (i11 = 0; i11 < kAcol; i11++) {
      b_G->data[i11] = -G->data[i11];
    }
    ...
    if (i < 200) {
      ...
      for (i29 = 0; i29 < 1; i29++) {
        for (i30 = 0; i30 < idx; i30++) {
          b_c->data[i30 + ar] = W_d->data[i30];
        }
      }

      i29 = r8->size[0] * r8->size[1];
      r8->size[0] = b_c->size[0];
      r8->size[1] = b_c->size[1];
      emxEnsureCapacity((emxArray__common *)r8, i29, (int)sizeof(double));
      br = b_c->size[1];
      for (i29 = 0; i29 < br; i29++) {
        ar = b_c->size[0];
        for (i30 = 0; i30 < ar; i30++) {
          r8->data[i30 + r8->size[0] * i29] = 0.0 * b_c->data[i30 + b_c->size[0]
            * i29];
        }
      }

      null_space(B, d_C, e_C, r8, p, r);
      ...
      for (i29 = 0; i29 < br; i29++) {
        x->data[i29] = (varargin_2->data[i29] > 1.0E-6);
      }
      ...
      br = ia * ar;
      for (i29 = 0; i29 < br; i29++) {
        r->data[i29] *= (double)(y->data[i29] > 1.0E-6);
      }
      ...
      if (sum(varargin_2) == 0.0) {
        ...
        br = temp->size[0];
        for (i29 = 0; i29 < br; i29++) {
          x->data[i29] = (temp->data[i29] < -1.0E-6);
        }
        ...
        i29 = I->size[0];
        I->size[0] = ii->size[0];
        emxEnsureCapacity((emxArray__common *)I, i29, (int)sizeof(double));
        br = ii->size[0];
        for (i29 = 0; i29 < br; i29++) {
        ...
        if (I->size[0] == 0) {
          ...
          for (i29 = 0; i29 < br; i29++) {
            ar = I->size[0];
            for (i30 = 0; i30 < ar; i30++) {
              a->data[i30 + a->size[0] * i29] = CW_A->data[((int)I->data[i30] +
                CW_A->size[0] * i29) - 1];
            }
          }
          ...
          br = c_C->size[0];
          for (i29 = 0; i29 < br; i29++) {
            f_C->data[i29] = c_C->data[i29] - CW_d->data[(int)I->data[i29] - 1];
          }
        ...
        if (alpha < 1.0) {
          ...
          b_CW_A->size[0] = 1;
          b_CW_A->size[1] = br;
          emxEnsureCapacity((emxArray__common *)b_CW_A, i29, (int)sizeof(double));
          for (i29 = 0; i29 < br; i29++) {
            b_CW_A->data[b_CW_A->size[0] * i29] = CW_A->data[(ar + CW_A->size[0]
              * i29) - 1];
          }
          ...
          for (i29 = 0; i29 < ia; i29++) {
            for (i30 = 0; i30 < ic; i30++) {
              b_W_A->data[i30 + b_W_A->size[0] * i29] = W_A->data[i30 + ic * i29];
            }
          }
